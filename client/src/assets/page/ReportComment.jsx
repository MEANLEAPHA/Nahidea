...
// Grouped by severity so the UI can give safety-critical reasons more
// visual weight without touching the brand accent color.
const REPORT_GROUPS = [
  {
    id: "content",
...
const ReportComment = () => {
  ...
  // Same recovery pattern as the comment composer: snapshot nav state so
  // a refresh or back/forward doesn't strand us with a null commentId.
