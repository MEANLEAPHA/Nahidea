          ...
          <div key={msg.id} className={`message-item ${isMe ? 'message-me' : 'message-other'}`}>
            {!isMe && <img src={msg.avatar} alt={msg.username} className="message-avatar" />}
             {isMe && (
                   <div className="message-actions">
                      <button className="message-action-btn" onClick={() => onEditMessage(msg)}><FontAwesomeIcon icon={faPenToSquare} /></button>
                      <button className="message-action-btn" onClick={() => onDeleteMessage(msg.id)}><FontAwesomeIcon icon={faTrashCan} /></button>
                    </div>
                  )}
            <div className="message-bubble">
              ...
              {isDeletedForMe ? (
                ...
                <div className="message-text">{msg.content} {msg.is_edited && !isDeletedForMe && <span className="message-edited">Edit*</span>}</div>
              )}
              ...
              <div className="message-footer">
                ...
                {isMe && (
                  ...
                  {!isMe && (
                     <div className="message-actions">
                       <button className="message-action-btn" onClick={() => onReplyMessage(msg)}><FontAwesomeIcon icon={faShareFromSquare} /> <small>Reply</small></button>
