...
const ProfileDropDown = ({ theme, toggleTheme, avatar_url}) => {
 ...
 const {user} = useAuth();
  ...
  // FIX: this state was missing — setIsOnline was being called with no
  // corresponding useState, which throws a ReferenceError on the first
  // 'online'/'offline' browser event.
